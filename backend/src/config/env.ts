...
export const env = {
  ...
  MORPH_RPC_URL: process.env.MORPH_RPC_URL || "https://rpc-holesky.morphl2.io", // Morph L2 Holesky RPC
  MORPH_CHAIN_ID: parseInt(process.env.MORPH_CHAIN_ID || "2810"), // Morph L2 chain ID (2810 for Holesky testnet)
  ...
  USDC_ADDRESS: process.env.USDC_ADDRESS!, // Morph L2 USDC contract address
