...
router.post('/cross-chain-quote', lifiController.getCrossChainQuote.bind(lifiController));
router.post('/quote/compare', lifiController.compareQuotes.bind(lifiController));
router.get('/quote/history/:userId', lifiController.getQuoteHistory.bind(lifiController));

// Execution endpoints
router.post('/execute', lifiController.executeTransaction.bind(lifiController));
router.post('/cross-chain-execute', lifiController.executeCrossChainTransaction.bind(lifiController));
router.get('/status/:executionId', lifiController.getTransactionStatus.bind(lifiController));
router.get('/execution/history/:userId', lifiController.getExecutionHistory.bind(lifiController));
